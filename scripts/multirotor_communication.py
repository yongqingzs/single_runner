...
class Communication:
    ...
    def hover(self):
        ...
        if self.current_position is None:
            print("NOTE: PX4 hasn't been completed!!!")
        else:
...
if __name__ == '__main__':
    # rospy.loginfo("Waiting for PX4 to start...")
    # try:
    #     rospy.wait_for_service(sys.argv[1]+'_'+sys.argv[2]+'/mavros/set_mode', timeout=60) # 设置超时时间
    #     rospy.loginfo("PX4 started, my node starting.")
